...
type PlayerGame = { code: string; phase: Phase; roundIndex: number; revision: number; players: Player[]; answered: string[]; me?: Player; round?: Omit<Round,"answer"> & { answer?: string } };
...
export default function Play() {
  ...
  const [busy, setBusy] = useState(false); const requestSequence = useRef(0);
